            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-2">
                ...
                <span className="text-muted-foreground">
                  123 Printing Street, Lahore, Pakistan
                </span>
              </li>
              <li className="flex items-center gap-2">
                <Phone className="h-5 w-5 text-primary flex-shrink-0" />
                <Link href="tel:+92XXXXXXXXX" className="text-muted-foreground hover:text-primary transition-colors">
                  +92-XXX-XXXXXXX
                </Link>
              </li>
              <li className="flex items-center gap-2">
                <Mail className="h-5 w-5 text-primary flex-shrink-0" />
                <Link href="mailto:info@fastprinting.com" className="text-muted-foreground hover:text-primary transition-colors">
