...
import { Menu, Phone, Printer, Package, Building2 } from "lucide-react";
              ...
              <nav className="flex flex-col py-4">
                ...
                <div className="border-t border-b bg-muted/30">
                  <Link
                    href="/services"
                    onClick={() => setMobileMenuOpen(false)}
                    className="px-6 py-3 text-base font-semibold hover:bg-accent transition-colors flex items-center justify-between"
                  >
                    Services
                  </Link>
