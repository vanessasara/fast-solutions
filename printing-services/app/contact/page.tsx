              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground mb-2">
                    <a href="tel:+92XXXXXXXXX" className="hover:text-primary transition-colors">
                      +92-XXX-XXXXXXX
                    </a>
                  </p>
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground mb-1">
                    <a href="mailto:info@fastprinting.com" className="hover:text-primary transition-colors">
                      info@fastprinting.com
                    </a>
                  </p>
                  <p className="text-muted-foreground">
                    <a href="mailto:sales@fastprinting.com" className="hover:text-primary transition-colors">
                      sales@fastprinting.com
                    </a>
                  </p>
                </CardContent>
              </Card>
      ...
      <section className="py-16 bg-muted/30">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
            Our team is available Monday through Saturday to answer your questions and provide instant quotes
          </p>
