...
const TravelFaq = () => {
     const faqs = [
        {
            question: "Can I book domestic and international flights through Fast Real Estate? ",
            answer: "Yes, we provide booking services for domestic and international flights, last-minute travel assistance, ticket changes, and refunds."
        },
        {
            question: " What types of visas can you assist with?",
            answer: "We assist with tourist visas, student visas, work visas, and business visas, providing guidance on documentation, appointments, and processing.."
        },
        {
            question: "How long does visa processing take?",
            answer: "Processing times vary by country and visa type. Our team provides estimated timelines and regular updates during the process."
        },
        {
            question: "Can I modify or cancel my flight booking?",
            answer: "Yes, we offer ticket change and refund assistance in accordance with airline policies."
        },
        {
            question: "Do you offer travel insurance?",
            answer: "Yes, we can provide guidance and options for travel insurance coverage tailored to your trip."
        },
    ];
