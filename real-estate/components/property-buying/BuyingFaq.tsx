...
const BuyingFaq = () => {
     const faqs = [
        {
            question: "How can I buy a property through Fast Real Estate? ",
            answer: "You can browse our property listings, filter by location, type, and budget, and contact our agents for guidance on purchase, negotiation, and documentation."
        },
        {
            question: " Can I sell my property online?",
            answer: "Yes, Fast Real Estate offers an online property selling form, listing packages, and marketing support to help you sell quickly and efficiently."
        },
        {
            question: "What property types are available?",
            answer: "We provide residential, commercial, plots, and rental properties, catering to different budgets and investment goals."
        },
        {
            question: "How do I know a property is verified?",
            answer: "All our listings undergo a verification process, ensuring ownership documents, legal status, and property details are accurate."
        },
        {
            question: "Do you offer property management services?",
            answer: "Yes, we provide tenant placement, rent collection, maintenance, and legal compliance services for landlords."
        },
    ];
